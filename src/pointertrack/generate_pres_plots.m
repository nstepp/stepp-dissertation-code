function generate_pres_plots(data)
...
set(gcf,'Position',[figPos(1) figPos(2) 750 300])

subplot(1,2,1);
errorbar(taus,mncorrs,secorrs,'linewidth',3);
%axis square;
set(gca,'fontsize',18)
...
subplot(1,2,2);
errorbar(taus,mnobs,seobs,'linewidth',3);
%axis square;
set(gca,'fontsize',18)
xlabel('\tau (s)','fontsize',18);
