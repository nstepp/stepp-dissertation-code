function pubgraph_trial_road(subj, trial, steering, gaze, starts, trial_roads, roads)
...
% steering angle
% positive theta matches land and lee 1994, negative is my convention
hold on;plot(-pos_z,theta,'k--','linewidth',3);hold off;
...
hold on;plot(-pos_z + gaze_vec(:,1)', -pos_x + gaze_vec(:,2)','k.-');hold off;
